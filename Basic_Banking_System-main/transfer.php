...
<body>
    ...
    <div>
        ...
        <div class="rightdiv">
            ...
            <br><br><br>
            <button  style=" border-radius: 4px;" class="transferbut" type="submit" name="submit"><b>Transfer</b></button>
            </form>
        </div>
    </div>
    <footer id="transfoot">
        <p>&nbsp;&copy 2021. Made by <b>yuvaraj KN</b><br>THE SPARKS FOUNDATION</p></p>
    </footer>
</body>
</html>